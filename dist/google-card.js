...
}, IMAGE_SOURCE_TYPES_MEDIA_SOURCE = 'media-source', IMAGE_SOURCE_TYPES_UNSPLASH_API = 'unsplash-api', IMAGE_SOURCE_TYPES_IMMICH_API = 'immich-api', IMAGE_SOURCE_TYPES_PICSUM = 'picsum', IMAGE_SOURCE_TYPES_URL = 'url', DEFAULT_CONFIG$1 = {
  image_url: '',
  display_time: 15,
  crossfade_time: 3,
  image_fit: 'contain',
  ...
  transitionToNewImage(newImage) {
    ...
    return _asyncToGenerator((function*() {
      ...
      if ('A' === _this5.activeImage) {
        ...
        yield new Promise((resolve => setTimeout(resolve, TIMING.TRANSITION_BUFFER)));
      ...
      yield new Promise((resolve => setTimeout(resolve, 1e3 * _this5.crossfadeTime + TIMING.TRANSITION_BUFFER)));
...
customElements.define('weather-display', class extends LitElement$1 {
  static get properties() {
    return {
      hass: {
        type: Object
...
customElements.define('night-mode', class extends LitElement$1 {
  static get properties() {
    return {
      currentTime: {
        type: String
  ...
  startFadeAnimation() {
    this.fadeTimer = setInterval((() => {
      ...
      this.requestUpdate();
    }), 20 * TIMING$1_NIGHT_MODE_TRANSITION_DELAY);
  }
  stopFadeAnimation() {
    if (this.fadeTimer) {
  ...
  renderTime() {
    return html$1(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral([ '<div class="night-time ', '">', '</div>' ])), this.getAnimationClass(), this.currentTime);
  }
  renderError() {
    return this.error ? html$1(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral([ '<div class="error-message">', '</div>' ])), this.error) : null;
  }
  render() {
    return html$1(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral([ '\n      <div\n        class="night-mode"\n        @touchstart="', '"\n        @touchmove="', '"\n        @touchend="', '"\n      >\n        ', ' ', '\n      </div>\n    ' ])), this.handleTouchStart, this.handleTouchMove, this.handleTouchEnd, this.renderTime(), this.renderError());
  }
  setBrightness(value) {
...
customElements.define('google-controls', class extends LitElement$1 {
  static get properties() {
    return {
      hass: {
        type: Object
  ...
  startOverlayDismissTimer() {
    ...
    this.overlayDismissTimer = setTimeout((() => {
      this.dismissOverlay();
    }), TIMING$1_OVERLAY_DISMISS_TIMEOUT);
  }
...
class GoogleCard extends LitElement$1 {
  ...
  setConfig(config) {
    ...
    this.config = _objectSpread2(_objectSpread2({}, DEFAULT_CONFIG$1), config);
  ...
  // Debug Info Methods
  renderDebugInfo() {
    return this.showDebugInfo ? html$1(_templateObject || (_templateObject = _taggedTemplateLiteral([ '\n      <div class="debug-info">\n        <h2>Background Card Debug Info</h2>\n        <p><strong>Night Mode:</strong> ', '</p>\n        <p><strong>Screen Width:</strong> ', '</p>\n        <p><strong>Screen Height:</strong> ', '</p>\n        <p><strong>Current Image:</strong> ', '</p>\n        <p><strong>Is Transitioning:</strong> ', '</p>\n        <p><strong>Brightness:</strong> ', '</p>\n        <p><strong>Volume:</strong> ', '</p>\n        <h3>Config:</h3>\n        <pre>', '</pre>\n      </div>\n    ' ])), this.isNightMode, this.screenWidth, this.screenHeight, 'A' === this.activeImage ? this.imageA : this.imageB, this.isTransitioning, this.brightness, this.volume, JSON.stringify(this.config, null, 2)) : null;
  }
  render() {
    return this.isNightMode ? html$1(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([ '\n        <night-mode\n          .currentTime="', '">\n        </night-mode>\n      ' ])), (new Date).toLocaleTimeString('en-US', {
      hour: 'numeric',
      minute: '2-digit',
      hour12: !0
    }).replace(/\s?[AP]M/, '')) : html$1(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([ '\n      <background-rotator\n        .imageA="', '"\n        .imageB="', '"\n        .activeImage="', '"\n        .isTransitioning="', '"\n        .crossfadeTime="', '">\n      </background-rotator>\n      \n      <weather-display\n        .hass="', '">\n      </weather-display>\n      \n      <google-controls\n        .brightness="', '"\n        .volume="', '"\n        .showOverlay="', '"\n        @brightness-change="', '"\n        @volume-change="', '">\n      </google-controls>\n\n      ', '\n      ', '\n    ' ])), this.imageA, this.imageB, this.activeImage, this.isTransitioning, this.config.crossfade_time, this.hass, this.brightness, this.volume, this.showOverlay, this.handleBrightnessChange, this.handleVolumeChange, this.error ? html$1(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral([ '<div class="error">', '</div>' ])), this.error) : '', this.renderDebugInfo());
  }
}
