...
customElements.define('google-controls', class extends LitElement {
  ...
  renderVolumeCard() {
    ...
    return html(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral([ '\n      <div\n        class="volume-card ', '"\n        style="transition: ', '"\n      >\n        <div class="volume-control">\n          <div class="volume-dots-container">\n            <div\n              class="volume-dots"\n              @click="', '"\n              @mousedown="', '"\n              @mousemove="', '"\n              @touchstart="', '"\n              @touchmove="', '"\n            >\n              ', '\n            </div>\n          </div>\n          <span class="volume-value">', '</span>\n        </div>\n      </div>\n    ' ])), this.showVolumeCard ? 'show' : '', this.volumeCardTransition, this.handleVolumeChange, this.handleVolumeDrag, (e => 1 === e.buttons && this.handleVolumeDrag(e)), this.handleVolumeDrag, this.handleVolumeDrag, [ ...Array(VOLUME_DOTS) ].map(((_, i) => html(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([ '\n                  <div\n                    class="volume-dot ', '"\n                    data-value="', '"\n                  ></div>\n                ' ])), i < volumeDisplayValue ? 'active' : '', i + 1))), volumeDisplayValue);
  }
  renderError() {
