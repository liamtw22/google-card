...
customElements.define('night-mode', class extends LitElement {
  ...
  renderTime() {
    return html(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral([ '<div class="night-time ', '">', '</div>' ])), this.getAnimationClass(), this.currentTime);
  }
  renderError() {
