...
customElements.define('background-rotator', class extends LitElement {
  ...
  static get styles() {
    return [ sharedStyles, css(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral([ '\n        :host {\n          display: block;\n          position: relative;\n          width: 100%;\n          : 100%;\n          overflow: hidden;\n          background-color: black;\n        }\n\n        .background-container {\n          position: absolute;\n          top: 0;\n          left: 0;\n          width: 100%;\n          : 100%;\n          background-color: black;\n          z-index: 1;\n        }\n\n        .background-image {\n          position: absolute;\n          top: 0;\n          left: 0;\n          width: 100%;\n          : 100%;\n          background-size: cover;\n          background-position: center;\n          background-repeat: no-repeat;\n          will-change: opacity, transform;\n          transition-property: opacity;\n          transition-timing-function: ease-in-out;\n          transform: translateZ(0);\n          backface-visibility: hidden;\n          -webkit-backface-visibility: hidden;\n          image-rendering: -webkit-optimize-contrast;\n          image-rendering: crisp-edges;\n        }\n\n        .error-message {\n          position: absolute;\n          top: 50%;\n          left: 50%;\n          transform: translate(-50%, -50%);\n          background-color: var(--color-error);\n          color: white;\n          padding: var(--spacing-4);\n          border-radius: var(--border-radius-md);\n          font-size: var(--font-size-base);\n          text-align: center;\n          z-index: 2;\n          max-width: 80%;\n        }\n      ' ]))) ];
  }
  connectedCallback() {
  ...
  getImageUrl(template) {
    ...
    var width = this.screenWidth, height = this.screenHeight, timestamp_ms = Date.now(), timestamp = Math.floor(timestamp_ms / 1e3);
 ...
 // Initial image load
  ...
  render() {
    ...
    return html(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral([ '\n      <div class="background-container">\n        ', '\n        <div\n          class="background-image"\n          style="\n            background-image: url(\'', '\');\n            opacity: ', ';\n            transition-duration: ', 's;\n            background-size: ', ';\n            image-rendering: -webkit-optimize-contrast;\n            image-rendering: crisp-edges;\n          "\n        ></div>\n        <div\n          class="background-image"\n          style="\n            background-image: url(\'', '\');\n            opacity: ', ';\n            transition-duration: ', 's;\n            background-size: ', ';\n            image-rendering: -webkit-optimize-contrast;\n            image-rendering: crisp-edges;\n          "\n        ></div>\n      </div>\n    ' ])), this.error ? html(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral([ '<div class="error-message">', '</div>' ])), this.error) : '', this.imageA || '', 'A' === this.activeImage ? 1 : 0, this.crossfadeTime, imageFit, this.imageB || '', 'B' === this.activeImage ? 1 : 0, this.crossfadeTime, imageFit);
  }
...
customElements.define('night-mode', class extends LitElement {
  ...
  render() {
    return html(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral([ '\n      <div class="night-mode"\n           @touchstart="', '"\n           @touchmove="', '"\n           @touchend="', '">\n        <div class="night-time ', '">', '</div>\n        <div class="touch-indicator"></div>\n        <div class="swipe-hint ', '">Swipe up to exit night mode</div>\n        ', '\n      </div>\n    ' ])), this.handleTouchStart, this.handleTouchMove, this.handleTouchEnd, this.isAnimating ? 'fade-dim' : '', this.currentTime, this.error ? '' : 'visible', this.error ? html(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral([ '<div class="error-message visible">', '</div>' ])), this.error) : '');
  }
  // Public methods for external control
  forceUpdate() {
    this.updateTime();
...
class GoogleCard extends LitElement {
    ...
    return _asyncToGenerator((function*() {
      ...
      _this.brightnessUpdateTimer = setTimeout( _asyncToGenerator((function*() {
        ...
        _this.brightnessStabilizeTimer = setTimeout((() => {
          ...
          _this.requestUpdate();
        }), TIMING_BRIGHTNESS_STABILIZE_DELAY);
      })), TIMING_BRIGHTNESS_DEBOUNCE_DELAY);
    }))();
  }
  setBrightness(value) {
    var _this2 = this;
  ...
  updated(changedProperties) {
    if (changedProperties.has('hass') && !this.isAdjustingBrightness && Date.now() - this.lastBrightnessUpdateTime > TIMING_BRIGHTNESS_STABILIZE_DELAY) {
  ...
  handleNightModeTransition(newNightMode) {
    ...
    return _asyncToGenerator((function*() {
      if (newNightMode) {
        ...
        yield new Promise((resolve => setTimeout(resolve, TIMING_NIGHT_MODE_TRANSITION_DELAY)));
        yield _this3.setBrightness(BRIGHTNESS_NIGHT_MODE);
        yield new Promise((resolve => setTimeout(resolve, TIMING_NIGHT_MODE_TRANSITION_DELAY)));
  ...
  handleBrightnessDrag(e) {
    var rect = this.shadowRoot.querySelector('.brightness-dots').getBoundingClientRect(), x = e.type.includes('touch') ? e.touches[0].clientX : e.clientX, relativeX = Math.max(0, Math.min(x - rect.left, rect.width)), newValue = Math.round(relativeX / rect.width * BRIGHTNESS_DOTS);
  ...
  getBrightnessDisplayValue() {
    return Math.round(this.visualBrightness / (BRIGHTNESS_MAX / BRIGHTNESS_DOTS));
  }
  renderDebugInfo() {
  ...
  renderBrightnessCard() {
    ...
    return html(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([ '\n      <div class="brightness-card ', '" \n           style="transition: ', '">\n        <div class="brightness-control">\n          <div class="brightness-dots-container">\n            <div class="brightness-dots" \n                 @click="', '"\n                 @mousedown="', '"\n                 @mousemove="', '"\n                 @touchstart="', '"\n                 @touchmove="', '">\n              ', '\n            </div>\n          </div>\n          <span class="brightness-value">', '</span>\n        </div>\n      </div>\n    ' ])), this.showBrightnessCard ? 'show' : '', this.brightnessCardTransition, this.handleBrightnessChange, this.handleBrightnessDrag, (e => 1 === e.buttons && this.handleBrightnessDrag(e)), this.handleBrightnessDrag, this.handleBrightnessDrag, Array.from({
      length: BRIGHTNESS_DOTS
    }, ((_, i) => i + 1)).map((value => html(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral([ '\n                <div class="brightness-dot ', '" \n                     data-value="', '">\n                </div>\n              ' ])), value <= brightnessDisplayValue ? 'active' : '', value))), brightnessDisplayValue);
  }
  static get styles() {
