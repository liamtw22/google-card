        ...
        <div class="icon-container">
          <div class="icon-row">
            <button class="icon-button" @click="${(e) => this.toggleBrightnessCard(e)}">
              <iconify-icon icon="material-symbols:sunny-outline-rounded" width="50" height="50" style="color: var(--control-text-color);"></iconify-icon>
            </button>
            <button class="icon-button">
              <iconify-icon icon="material-symbols:volume-up-outline-rounded" width="50" height="50" style="color: var(--control-text-color);"></iconify-icon>
            </button>
            <button class="icon-button">
              <iconify-icon
            ...
            <button class="icon-button">
              <iconify-icon icon="material-symbols:alarm-add-outline-rounded" width="50" height="50" style="color: var(--control-text-color);"></iconify-icon>
            </button>
            <button
              class="icon-button"
            ...
            >
              <iconify-icon icon="material-symbols:settings-outline-rounded" width="50" height="50" style="color: var(--control-text-color);"></iconify-icon>
            </button>
          </div>
        </div>
      </div>
